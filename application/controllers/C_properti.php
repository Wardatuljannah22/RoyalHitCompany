...
class C_properti extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('M_properti', 'properti');
    }

    public function index()
    {
        $data['view_file'] = 'admin/moduls/V_properti';
        $data['result'] = $this->properti->properti()->result();
    ...
    public function add_produk()
    {
        ...
        $dataInsert['nama_properti'] = $nama_properti;
        $dataInsert['deskripsi_properti'] = $deskripsi_properti;

        foreach ($dataUpload as $key => $value) {
            $dataInsert[$key] = $value;
        }

        if ($this->properti->insert($dataInsert)) {
    ...
    public function hapus_produk()
    {
        ...
        $getData = $this->properti->properti($id);
    ...
    public function modal_edit_produk()
    {
        ...
        return JSONResponse(array(
            'RESULT' => 'OK',
            'HTML' => $this->load->view('admin/moduls/properti/edit', $data, true)
        ));
    }
    ...
    public function edit_produk()
    {
        ...
        $nama_properti = getPost('nama_properti');
        $deskripsi_properti = getPost('deskripsi_properti');

        $updateData['nama_properti'] = $nama_properti;
        $updateData['deskripsi_properti'] = $deskripsi_properti;
        ...
        if ($this->properti->update($id, $updateData)) {
